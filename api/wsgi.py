...
setups = {
    ...
    "Horse Lords vs. Castle Folk": {
        ...
        "pieces": [
                ...
                {"x":3, "y":6, "type":"pawn", "colour":"white"},
                {"x":4, "y":6, "type":"pawn", "colour":"white"},
                {"x":5, "y":6, "type":"siege_tower", "colour":"white"},
                {"x":0, "y":7, "type":"giraffe", "colour":"white"},
                {"x":1, "y":7, "type":"shaman", "colour":"white"},
                {"x":2, "y":7, "type":"empress", "colour":"white"},
                {"x":3, "y":7, "type":"king", "colour":"white"},
                {"x":4, "y":7, "type":"shaman", "colour":"white"},
                {"x":5, "y":7, "type":"giraffe", "colour":"white"},
